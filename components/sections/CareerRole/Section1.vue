                ...
                <div class="col-xl-10">
                    ...
                    <div class="txt-block role-info">
                        ...
                        <p>Sagittis congue augue egestas integer velna purus purus magna nec suscipit and egestas magna
                            ...
                            massa elementum. Libero quisque lacus and ligula massa lorem fusce cursus fusce nulla vitae
                            massa placerat and mollis, sapien gravida aliquet ipsum ultrices aliquet lorem diam purus
                            undo vitae aliquam auris dapibus libero fusce blandit.</p>
                        <!-- Text -->
                        ...
                        <hr />
                        <!--Title -->
                        <h5 class="s-24 w-700">What would you do at A4ManagementTools?</h5>
                        <!-- Text -->
                        ...
                        <ul class="simple-list long-list">
                            <li class="list-item">
                                <p>Blandit velna vitae auctor congue magna and tempor sapien a gravida laoreet turpis
                                </p>
                            </li>
                            <li class="list-item">
                            ...
                            <li class="list-item">
                                <p>Vitae auctor blandit velna congue magna and tempor sapien a turpis laoreet gravida
                                </p>
                            </li>
                            <li class="list-item">
                            ...
                            <div class="row align-items-center row-cols-1 row-cols-md-2">
                                ...
                                <div class="col">
                                    <div id="cb-6-3" class="cbox-6">
                                        ...
                                        <!-- Text -->
                                        <p>Mauris donec mullam blandit at tempor sapien gravida donec ipsum, at porta
                                            justo velna vitae auctor congue magna nihil impedit ligula</p>
                                    </div>
                                </div>
                                <!-- CONTENT BOX #4 -->
                                <div class="col">
