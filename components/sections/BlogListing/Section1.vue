                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="blog-post-img">
                            <img class="img-fluid r-16" src="/assets/images/blog/post-11-img.jpg"
                                alt="blog-post-image" />
                        </div>
                    </div>
                    <!-- BLOG POST TEXT -->
                    <div class="col-md-6">
                        <div class="blog-post-txt">
                            ...
                            <!-- Post Link -->
                            <h3 class="s-38 w-700">
                                <NuxtLink to="/single-post">Congue magna tempor and ipsum A4ManagementTools sapien
                                    turpis laoreet augue </NuxtLink>
                            </h3>
                            <!-- Text -->
                            <p>Aliqum mullam blandit vitae and tempor sapien and donec lipsum gravida porta undo velna
                                dolor libero a risus aliquet tempus posuere a tempor velna tempus posuere dolor</p>
                            <!-- Post Meta -->
                            <div class="blog-post-meta mt-30">
                                <ul class="post-meta-list ico-10">
                                    <li>
                                        <p class="w-500">By A4ManagementTools Team</p>
                                    </li>
                        ...
                        <div class="blog-post mb-40 wow fadeInUp clearfix">
                            ...
                            <div class="blog-post-txt">
                                ...
                                <p>Egestas luctus vitae augue and ipsum ultrice quisque in cursus lacus feugiat congue
                                    diam ultrice laoreet sagittis</p>
                                <!-- Post Meta -->
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-post mb-40 wow fadeInUp clearfix">
                            ...
                            <div class="blog-post-txt">
                                ...
                                <!-- Post Link -->
                                <h6 class="s-20 w-700">
                                    <NuxtLink to="/single-post">Porttitor cursus fusce neque CEO egestas cursus magna
                                        sapien and suscipit ipsum </NuxtLink>
                                </h6>
                                <!-- Text -->
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="blog-post mb-40 wow fadeInUp clearfix">
                            ...
                            <div class="blog-post-txt">
                                ...
                                <!-- Post Link -->
                                <h6 class="s-20 w-700">
                                    <NuxtLink to="/single-post">Cubilia laoreet ipsum augue eget egestas
                                        A4ManagementTools magna</NuxtLink>
                                </h6>
                                <!-- Text -->
                                <p>Luctus vitae egestas augue and ipsum ultrice quisque in cursus lacus feugiat egets
                                    congue ultrice sagittis laoreet</p>
                                <!-- Post Meta -->
                                <div class="blog-post-meta mt-20">
                                    <ul class="post-meta-list ico-10">
                                        <li>
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="blog-post mb-40 wow fadeInUp clearfix">
                            ...
                            <div class="blog-post-txt">
                                ...
                                <!-- Post Link -->
                                <h6 class="s-20 w-700">
                                    <NuxtLink to="/single-post">Cursus porttitor fusce neque CEO egestas cursus magna
                                        sapien and ipsum suscipit </NuxtLink>
                                </h6>
                                <!-- Text -->
                                ...
                                <div class="col-md-6 order-last order-md-2">
                                    <div class="blog-post-txt color--white">
                                        ...
                                        <h4 class="s-34 w-700 mb-20">
                                            <NuxtLink to="/single-post">Lipsum sodales sapien A4ManagementTools aliquet
                                                blandit augue gravida posuere </NuxtLink>
                                        </h4>
                                        <!-- Text -->
                                        <p>Aliqum mullam blandit vitae and tempor sapien and donec lipsum gravida porta
                                            undo velna dolor libero risus aliquet tempus posuere vitae tempor</p>
                                        <!-- Post Meta -->
                                        <div class="blog-post-meta mt-30">
                                            <ul class="post-meta-list ico-10">
                                                <li>
