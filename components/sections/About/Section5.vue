                ...
                <div class="row row-cols-1 row-cols-md-2 rows-3">
                    ...
                    <div class="col">
                        <div class="fbox-11 fb-1 wow fadeInUp">
                            ...
                            <div class="fbox-txt">
                                ...
                                <p>80+ Tools, A4 format with integrated procedures of key business and HR management
                                    activities.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="fbox-11 fb-2 wow fadeInUp">
                            ...
                            <!-- Text -->
                            <div class="fbox-txt">
                                <h6 class="s-22 w-700">2 Comprehensive Assessments of the Organization</h6>
                                <p>2 Self-assessments (business management and process management) based on
                                    international
                                    standards. 2 Three-year development plans with 300+ development activities
                                    integrated by
                                    A4ManagementTools.</p>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="fbox-11 fb-3 wow fadeInUp">
                            ...
                            <div class="fbox-txt">
                                ...
                                <p>150+ hours-lessons of self-paced trainings inherent to each A4ManagementTool. A
                                    practice-based digital learning place. At the user's pace, online or in-person.</p>
                            </div>
                        </div>
                    </div>
                    <!-- END FEATURE BOX #3 -->
                    ...
                    <div class="col">
                        <div class="fbox-11 fb-4 wow fadeInUp">
                            ...
                            <div class="fbox-txt">
                                ...
                                <p>1 HR development planning tool. Automated summons.</p>
                            </div>
                        </div>
                    </div>
                    <!-- END FEATURE BOX #4 -->
                    ...
                    <div class="col">
                        <div class="fbox-11 fb-4 wow fadeInUp">
                            ...
                            <div class="fbox-txt">
                                ...
                                <p>The new Integrated Presentation Technology (IPT). Project progress to your team or
                                    superiors
                                    with 1 click, 0 minutes of preparation and 0 PowerPoint.</p>
                            </div>
                        </div>
                    </div>
                    <!-- END FEATURE BOX #4 -->
                    ...
                    <div class="col">
                        <div class="fbox-11 fb-4 wow fadeInUp">
                            ...
                            <div class="fbox-txt">
                                ...
                                <p>Managers dedicated to customer success. Facilitation of implementation of
                                    A4ManagementTools.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="fbox-11 fb-4 wow fadeInUp">
                            ...
                            <div class="fbox-txt">
                                ...
                                <p>70% tool practice, 30% theory. Comparison of managers with 10+ years of experience.
                                    In
                                    partnership with the Swiss University of Applied Sciences (SUP).</p>
                            </div>
                        </div>
                    </div>
                    <!-- END FEATURE BOX #4 -->
                    ...
                    <div class="col">
                        <div class="fbox-11 fb-5 wow fadeInUp">
                            ...
                            <div class="fbox-txt">
                                ...
                                <p>Recommendations. Instructions, advanced techniques, risks and remedies, insights and
                                    common
                                    mistakes to avoid.</p>
                            </div>
                        </div>
