            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-6 col-lg-5 offset-md-6 offset-lg-7">
                    <div id="hero-22-form" class="r-10 wow fadeInLeft">
                        ...
                        <!-- Text -->
                        <p class="p-md color--grey">Get started with A4ManagementTools for free. It's fast and very
                            easy! No credit card needed</p>
                        <!-- Form -->
                        <form name="requestForm" class="row request-form">
                            ...
                            <div class="col-md-12 form-btn">
                                <button type="submit" class="btn btn--theme hover--theme submit">Get Started
                                    Now</button>
                            </div>
                            <!-- Form Message -->
