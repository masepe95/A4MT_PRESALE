                            ...
                            <div class="col-md-6">
                                <div class="register-page-form">
                                    <form name="signupform" class="row sign-up-form">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-data">
                                                <span>By clicking “Create Account”, you agree to our <NuxtLink
                                                        to="/terms">Terms</NuxtLink> and that you have read our
                                        ...
                                        <!-- Log In Link -->
                                        <div class="col-md-12">
                                            <p class="create-account text-center">Already have an account? <a
                                                    href="login-2" class="color--theme">Log in</a></p>
                                        </div>
                                    </form>
                                </div>
                            </div>
