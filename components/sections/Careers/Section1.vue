                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="txt-block left-column color--black wow fadeInRight">
                            ...
                            <!-- Text -->
                            <p class="p-lg w-400">As Associate Customer Success Manager you offer strategic consulting,
                                coaching and training and become responsible for the success of Customer Organisations.
                                Support current and new customers through A4ManagementTools.
                                Discover what it means to be part of our global network.</p>
                        </div>
                    </div>
                    <!-- END TEXT BLOCK -->
                    <!-- IMAGE BLOCK -->
                    <div class="col-md-6">
                        <div class="img-block right-column wow fadeInLeft">
                            <img class="img-fluid" src="/assets/images/picture3.png" alt="content-image" />
                        </div>
                    </div>
                </div>
                <!-- End row -->
